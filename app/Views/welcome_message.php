...
<body>
	...
	<script>
		$(document).ready(function name() {
			console.log("test");
			var pusher = new Pusher('a189c31a94dae4644a9f', { //ganti dengan app_key pusher Anda
			...
			channel.bind('my-event', function(data) {
				if (data.message === 'success') {
					...
					loadDoc(); //panggil function show_product saat message success
				}
			...
			function loadDoc() {
				...
				xhttp.open("GET", "http://localhost:8080/pemantauan");
				xhttp.send();
			}
